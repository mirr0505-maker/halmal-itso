...
>
> 최종 갱신: 2026-04-30 (v3 피드 인라인 광고 추가)
...
### P3 — 광고 노출 영역 확장 (v3, 2026-04-30 도입)

- [x] **P3-14** 피드 인라인 광고 (Native In-feed Ad) — 글 목록 그리드 인라인 카드 ✅ 2026-04-30
  - 글카드 형태 + violet 톤 + 좌상단 📢 광고 배지 (Brand Safety)
  - 글 작성자 무관, 100% 플랫폼 수익 (본문 슬롯과 RS 분리)
  - 카테고리 뷰 무조건 ON / 홈 'recent' 탭 ON / 새글·사적 탭 OFF
  - 청크당 1광고 (8글당 1, 12.5% 밀도 — 베타 후 4:1 조정 검토)
- [x] **P3-14b** 본문/피드 광고 등록 진입 분리 (v3.1) ✅ 2026-04-30
  - AdTypeSelector 신규 — 새 광고 클릭 시 [📄 본문][📋 피드] 카드 2개 선택
  - 본문 광고: imageStyle/imagePosition/targetCreatorId/슬롯3종 선택 노출
  - 피드 광고: targetSlots=['feed'] 자동, 본문 전용 필드 모두 숨김
  - AdMarketplaceModal에서 피드 광고 자동 제외 (작성자 picker)
  - AdCampaignList 카드 좌상단 [📄 본문]/[📋 피드] 배지
  - 폼 내 본문/피드 슬롯 탭 UI 제거 (진입 분리로 불필요)
- [ ] **P3-15** 피드 빈도 캡 별도 limit — 본문(default 24h 3회)과 분리, 피드는 24h 5회 등 정책 분기
- [ ] **P3-16** 피드 광고 단가 책정 — D+7 viewableRate 분포 분석 후 본문 대비 ±N% 조정
- [ ] **P3-17** 피드 광고 4:1 밀도 조정 — 청크 패턴 변경 또는 idx===3,7 두 곳 인서트
- [ ] **P3-18** 피드 광고 통계 분리 — AdStatsModal에 본문/피드 분해 차트 추가
