...
- [x] **S-13 자동매칭 명시 결정 — selectedAds[pos]='auto'** ✅ 2026-04-28 통과 (라벨 3분기 + Firestore 'auto' 저장 + 매칭 분기 fallback 정상)

### D+1 (2026-04-28) 이후 검증

- [x] **S-14 aggregateAdStats 첫 일치 데이터** ✅ 2026-04-28 통과 (ad_stats_daily 문서 생성 + KPI/슬롯/메뉴 필드 정상. byRegion 누락은 커밋 9a201a2(2026-04-28 15:21)로 해소 — 2026-04-29 적재 adEvents에 `viewerRegion: "서울"` 저장 확인, 2026-04-30 04:30 KST 집계부터 byRegion 정상 반영 예정)
- [x] **S-15 AdStatsModal 데이터 노출** ✅ 2026-04-28 통과 (모달 정상 / KPI 4종 / 일별 트렌드 / 슬롯·메뉴 분해 / 24h 히트맵 표시. 지역별 분해는 2026-04-30 집계분부터 노출)
