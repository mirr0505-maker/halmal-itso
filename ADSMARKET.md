...
### 3.1 레벨별 광고 슬롯 & 수익 배분율

| 유저 레벨 | 슬롯 개수 | 슬롯 위치 | 작성자 RS | 플랫폼 RS | 광고 선택 권한 |
|-----------|----------|-----------|-----------|-----------|--------------|
| Lv 1~4 | 0 | — | 0% | 100% | 없음 (플랫폼 광고만) |
| Lv 5~6 | 1 | bottom | 30% | 70% | 시스템 자동 할당 |
| Lv 7~8 | 2 | top, bottom | 50% | 50% | 카테고리별 광고 선택 가능 |
| Lv 9~10 | 3 | top, middle, bottom | 70% | 30% | 최고 단가 광고 우선권 |
