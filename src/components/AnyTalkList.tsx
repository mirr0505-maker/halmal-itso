            ...
            >
              ...
              <div className="flex justify-between items-center mb-1.5">
                ...
                <div className="flex gap-0.5">
                  {[1, 2, 3].map((idx) => (
                    <svg 
                      key={idx}
                      className={`w-3 h-3 transition-colors ${idx <= promoLevel ? 'text-rose-400 fill-current' : 'text-slate-100'}`} 
              ...
              <div className="flex justify-between items-center mb-2 border-b border-slate-50 pb-1.5">
                ...
                <div className="flex items-center gap-2 text-slate-400 text-[10px] font-black shrink-0">
                  ...
                  <div className="flex items-center gap-0.5">
                    <svg className={`w-3 h-3 transition-colors ${isLikedByMe ? 'fill-current text-rose-400' : 'fill-none text-rose-200'}`} viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
              ...
              <div className="flex items-center justify-between">
                ...
                >
                  <svg className={`w-4 h-4 transition-colors ${isLikedByMe ? 'text-rose-400 fill-current' : 'text-rose-200 group-hover/like:text-rose-400 fill-none'}`} viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
                    <path d="M11.645 20.91l-.007-.003-.022-.012a15.247 15.247 0 01-.383-.218 25.18 25.18 0 01-4.244-3.17C4.688 15.36 2.25 12.174 2.25 8.25 2.25 5.322 4.714 3 7.688 3A5.5 5.5 0 0112 5.052 5.5 5.5 0 0116.313 3c2.973 0 5.437 2.322 5.437 5.25 0 3.925-2.438 7.111-4.739 9.256a25.175 25.175 0 01-4.244 3.17 15.247 15.247 0 01-.383.219l-.022.012-.007.004-.003.001a.752.752 0 01-.704 0l-.003-.001z" />
                  </svg>
                </button>
              </div>
