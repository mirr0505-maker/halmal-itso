// src/components/PostCommentForm.tsx — 게시글 상세 화면의 댓글/연계글 작성 폼
...
const PostCommentForm = ({
  rule, replyTarget, setReplyTarget,
  selectedSide, setSelectedSide, selectedType, setSelectedType,
  ...
  return (
    <div className="bg-[#F8FAFC] md:px-8 py-3 border-b border-slate-200">
      {(rule.allowDisagree || rule.allowFormal) ? (
        /* 토론/팩트체크 등 — 탭 셀렉터 포함 */
