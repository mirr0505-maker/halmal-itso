...
> 최종 갱신: 2026-04-13 v1.7 (정보봇 Phase 1-2 + 닉네임 배지 + 소곤소곤 개선)  |  연계 파일: `blueprint.md` §8

---

## 1. 개요

**우리들의 장갑(Glove)** 은 글러브(Geulove) 플랫폼 내 커뮤니티 시스템입니다.
...
- 수익: 글러브(Geulove) 플랫폼 **100%** (`platform_revenue/glove_bot`)
